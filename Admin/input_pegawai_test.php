...
<body class="fixed-left">
   <!-- <form action="proses_input.php" method="POST">
        ...
        <input type="text" name="nama_pegawai" id="text" placeholder="Nama">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="proses_input.php" method="POST">
                                            <div class="form-group row">
                                                <label for="example-text-input" class="col-sm-2 col-form-label">NIP<label style="color: red;">*</label></label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" name="nip" placeholder="No NIP Tanpa Spasi">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="example-text-input" class="col-sm-2 col-form-label">Nama<label style="color: red;">*</label></label>
                                                <div class="col-sm-10">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">Jabatan<label style="color: red;">*</label></label>
                                                <div class="col-sm-10">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">Pangkat Golongan<label style="color: red;">*</label></label>
                                                <div class="col-sm-10">
